  ...
  async function handleLogin() {
    ...
    try {
      ...
      if (user.role !== "officer" && user.role !== "admin") {
        ...
        throw new Error(
          "This account does not have permission to access the officer dashboard."
        );
      }
      ...
      <section className="mx-auto grid min-h-screen max-w-[1440px] gap-8 px-5 py-8 md:px-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        ...
        <div className="overflow-hidden rounded-[32px] border border-[#E5E7EB] bg-white shadow-[0_24px_60px_rgba(10,10,10,0.06)]">
          ...
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(180deg, rgba(10,10,10,0.08) 0%, rgba(10,10,10,0.52) 100%), url('${heroImage}')`,
          ...
          <div className="p-6 md:p-8">
            ...
            >
              Review AI Escalations And Guide Farmers With Expertise.
            </h1>

            <p className="mt-4 max-w-xl text-base leading-8 text-[#6B7280]">
              When the AI system cannot confidently resolve a farmer's query,
              cases are escalated to agricultural officers. Sign in to review
              crop issues, analyze images, and provide expert recommendations
              directly to farmers.
            </p>
        ...
        <div>
          ...
          <a
            className="mb-4 inline-flex items-center text-sm font-semibold text-[#0A0A0A] transition hover:text-[#2E7D32]"
            href="/"
          >
            Back to home
          </a>
          ...
          >
            ...
            <div className="text-[12px] uppercase tracking-[0.24em] text-[#6B7280]">
              Officer dashboard
            </div>
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-display)" }}
            >
              Sign in to manage escalations.
            </h2>

            <p className="mt-4 text-sm leading-7 text-[#6B7280]">
              Access is restricted to verified agricultural officers.
            </p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <label className="block text-sm font-medium text-[#0A0A0A]">
                Email
                <input
                  className="mt-2 w-full rounded-[22px] border border-[#E5E7EB] bg-[#FCFCFB] px-4 py-3 outline-none transition focus:border-[#2E7D32]"
                  onChange={(event) => setEmail(event.target.value)}
                  placeholder="officer@agriculture.gov"
                  type="email"
                  value={email}
                />
              </label>
              ...
              <button
                className="inline-flex h-12 w-full items-center justify-center rounded-full bg-[#0A0A0A] px-5 text-base font-semibold text-white disabled:cursor-not-allowed disabled:bg-[#9CA3AF]"
                disabled={loading || !email || !password}
                onClick={handleLogin}
                type="button"
              >
                {loading ? "Signing in..." : "Open Officer Dashboard"}
